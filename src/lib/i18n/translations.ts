...
export const translations = {
  zh: {
    ...
    hero: {
      ...
      title: "面向 AI 生成单页的交互展厅与托管沙箱",
      desc: "专为单文件 HTML、Claude Artifacts 与 Canvas 产物设计。无需配置 Git 仓库与构建流程，上传即可生成独立访问链接，自带安全隔离沙箱。",
    },
    categories: {
      all: "全部",
      tools: "实用工具",
    ...
    gallery: {
      ...
      noProjectsTitle: "未找到匹配的项目",
      noProjectsDesc: "可尝试调整搜索词，或前往控制台上传新的 HTML 单页应用。",
      uploadNow: "+ 上传新作品",
      openRunner: "在线运行",
      viewCode: "查看代码",
      openDirect: "打开",
    ...
    pricing: {
      badge: "方案与价格",
      title: "透明清晰的方案，自建与云端均可选用",
      desc: "完全开源，支持自由部署在个人的 Vercel 与云存储；亦可直接选用我们的全托管云服务。",
      freePlan: {
        name: "免费版 (Starter)",
        price: "¥0",
        period: "/ 永久免费",
        desc: "适合个人开发者与探索者托管并分享独立的 HTML 单页作品。",
        cta: "立即免费开始",
        features: [
          "无限公开项目展示与托管",
      ...
      faqTitle: "常见问题解答 (FAQ)",
      faqDesc: "关于托管架构、安全沙箱、端到端加密与自定义域名的详细说明。",
      faqs: [
        {
          q: "Pagepod 与传统的 Vercel 或 GitHub Pages 有何不同？",
          a: "Pagepod 专为单文件 HTML 与 AI 交互产物打造。无需初始化代码仓库、安装依赖或配置流水线，上传文件或粘贴代码即可获得受沙箱保护的独立运行链接与画廊展示。",
        },
        {
          q: "私密 HTML 作品能否确保不被平台窥探？",
          a: "可以。在私密模式下，文件在浏览器端即完成 AES-GCM-256 加密，上传到存储的仅为密文。解密密钥由用户本地持有或通过带 Hash 链接传递，服务端无权接触明文。",
        },
        {
          q: "是否支持免费自建私有实例？",
          a: "完全支持。Pagepod 100% 开源，你可以免费部署到自己的 Vercel、Supabase 与 Cloudflare R2 账户，数据自主可控且无带宽费用。",
        },
        {
          q: "支持哪些文件格式？",
          a: "支持直接粘贴 HTML 代码、上传单文件 `.html`，以及包含 CSS、JS 与图片等静态资源的 `.zip` 压缩包。系统会自动解析入口文件并加载相对路径资源。",
        },
        {
          q: "为何设置敏感信息检测？",
          a: "HTML 属于纯前端代码，公开后源码完全可见。为避免误将 API 密钥或凭证发布到公网，我们在前端提供了静态检测，在公开发布前给出安全提示。",
        },
      ],
    },
    explore: {
      badge: "精选专题与场景灵感",
      title: "探索社区创作的交互单页与创意实现",
      desc: "按场景汇聚实用工具、网页轻游戏、数据看板与交互原型，在独立沙箱中即时体验。",
      viewAll: "前往画廊浏览全量项目",
      openInRunner: "在沙箱中运行",
      popularTags: "按创作生态与技术栈探索",
    ...
    aboutPage: {
      badge: "关于 Pagepod",
      title: "为什么构建 Pagepod",
      subtitle: "现代大语言模型能在数秒内生成富有创意的单页应用、实用工具与微型游戏。然而将这些碎片化代码变为可访问、可安全分享的在线服务，仍常受困于繁复的环境配置与部署流程。Pagepod 致力于消除这些工程摩擦。",
      pillars: [
        {
          title: "零配置即时运行",
          desc: "无需创建 Git 仓库或安装依赖，单文件 HTML 与 Zip 资源包即传即用，毫秒级就绪。",
        },
        {
          title: "端到端本地加密",
          desc: "私密项目直接在浏览器本地通过 AES-GCM-256 加密存储，服务端与数据库均无法触及明文。",
        },
        {
          title: "开源且完全可自建",
          desc: "代码完全开源，支持一键部署到个人的 Vercel、Supabase 与 Cloudflare R2，无任何厂商锁定。",
        },
        {
          title: "REST API 自动化集成",
          desc: "提供规范的 OpenAPI 接口与访问令牌，轻松与 Cursor、自动化脚本及构建流程协同。",
        },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      title: "Interactive showcase and hosting for AI single pages",
      desc: "Purpose-built for standalone HTML files, Claude Artifacts, and Canvas outputs. Upload instantly for isolated sandboxed execution and clean shareable links.",
    },
    categories: {
      all: "All",
      tools: "Tools",
    ...
    gallery: {
      ...
      noProjectsDesc: "Try adjusting your search query, or upload a new single-page application in the console.",
    ...
    explore: {
      badge: "Curated Collections & Topics",
      title: "Explore interactive single-page artifacts",
      desc: "Handpicked developer utilities, web mini-games, dynamic charts, and UI prototypes ready for instant interaction in the sandbox.",
    ...
    aboutPage: {
      ...
      subtitle: "Modern AI models generate functional web tools, mini-games, and prototypes in seconds. Yet hosting and sharing them still involves boilerplate repository setups, build configs, and server friction. Pagepod removes that friction entirely.",
      pillars: [
        {
          title: "Instant Zero-Config Execution",
          desc: "No Git repositories or build pipelines required. Deploy single-file HTML and asset zips in milliseconds.",
        },
        {
          title: "Client-Side End-to-End Encryption",
          desc: "Private artifacts are encrypted in the browser with AES-GCM-256 before upload. Neither servers nor databases can inspect your source code.",
        },
        {
          title: "Open Source & Self-Hostable",
          desc: "Fully open source with 1-click deployment on Vercel, Supabase, and Cloudflare R2 with complete data ownership.",
        },
        {
          title: "REST API & Workflow Automation",
          desc: "Standard OpenAPI endpoints with personal access tokens to seamlessly integrate with Cursor, CLI scripts, and pipelines.",
        },
      ],
