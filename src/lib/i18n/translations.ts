...
export const translations = {
  zh: {
    ...
    pricing: {
      badge: "方案与定价",
      title: "透明清晰的方案，自由掌控",
      desc: "完全开源，自由部署于个人的基础设施；亦可选择我们的全托管云端服务，即启即用。",
      freePlan: {
        name: "免费版 (Starter)",
        price: "¥0",
        period: "/ 永久免费",
        desc: "适合个人开发者与极客探索并策展独立的 HTML 交互作品。",
        cta: "立即免费开始",
        features: [
          "无限公开项目展示与托管",
      ...
      faqs: [
        {
          ...
          a: "Pagepod 专为单文件 HTML 与 AI 交互产物打造。无需初始化仓库、安装依赖或配置流水线，上传代码即刻拥有受沙箱保护的永久运行链接与画廊展位。",
        },
        {
          q: "私密 HTML 作品能否确保不被平台窥探？",
          a: "可以。在私密模式下，文件在浏览器本地通过 Web Crypto AES-GCM-256 加密后再行上传，密钥由创作者本地持有，平台服务端仅存储密文数据。",
        },
        {
          q: "是否支持免费自建私有实例？",
          a: "完全支持。Pagepod 遵循宽松的 MIT 协议开源，你可以一键部署到个人的 Vercel、Supabase 与 Cloudflare R2 账户，数据完全由你掌控。",
        },
        {
          q: "支持哪些文件格式？",
          a: "支持直接粘贴 HTML 代码、上传单文件 `.html`，以及包含 CSS、JS 与多媒体资源的 `.zip` 压缩包。系统会自动解析根入口与相对路径资源。",
        },
        {
          q: "为何设置敏感信息检测？",
          a: "公开的 HTML 属于纯前端代码，源码完全公开。为避免误将 API 密钥或凭证发布到公网，我们在前端提供了静态检测，在公开发布前给出安全提示。",
        },
      ],
    },
    explore: {
    ...
    aboutPage: {
      ...
      pillars: [
        ...
        },
        {
          ...
          desc: "Private artifacts are encrypted in the browser with Web Crypto AES-GCM-256. Only key holders can view them; servers only see ciphertext.",
        },
        {
