...
export const translations = {
  zh: {
    ...
    gallery: {
      searchPlaceholder: "搜标题、路径或标签...",
      totalCount: "共 {count} 个单页",
      noProjectsTitle: "没有找到相关单页",
      noProjectsDesc: "换个词搜搜看，或者去工作区自己上传一个。",
      uploadNow: "+ 上传新单页",
      openRunner: "在线运行",
      viewCode: "查看代码",
      openDirect: "打开",
    ...
    pricing: {
      badge: "托管方案",
      title: "按需选择适合你的方式",
      desc: "Pagepod 完全开源，可以一键部署到自己的 Vercel 和云存储上使用；如果你不想自己维护，也可以使用我们提供的托管服务。",
      freePlan: {
        name: "免费版 (Starter)",
        price: "¥0",
        period: "/ 永久免费",
      ...
      faqs: [
        ...
        {
          q: "私密 HTML 页面别人能看到吗？",
          a: "不能。开启私密模式后，代码在浏览器本地就会用 AES-GCM 加密，存到服务器上的只有密文。解密密钥只保存在你的本地或包含在专属链接里，服务端也无法查看源码。",
        },
        {
          q: "可以免费部署到自己的账号上吗？",
          a: "可以。Pagepod 遵循 MIT 协议开源，你可以免费部署到自己的 Vercel 与 Supabase 账户，配合 Cloudflare R2 存储，没有额外的带宽费用。",
        },
        {
          q: "支持上传哪些类型的文件？",
          a: "支持直接粘贴 HTML 代码、上传单文件 `.html`，以及包含 CSS、JS、图片的 `.zip` 压缩包。系统会自动找出入口文件并加载相对路径资源。",
        },
        {
          q: "为什么会有敏感信息检测？",
          a: "HTML 是纯前端代码，公开后任何人都能查看源码。为了避免不小心把 API Key 或密码发到公网上，我们在前端加了扫描提示。",
        },
      ],
    },
    explore: {
  ...
  en: {
    ...
    explore: {
      badge: "Collections",
      title: "See what people are building with AI",
      desc: "A collection of single-page tools, calculators, games, and prototypes created with Claude and ChatGPT. Click any card to try it out in the sandbox.",
      viewAll: "Browse all in Showcase",
      openInRunner: "Run in sandbox",
      popularTags: "Filter by tag",
    ...
    aboutPage: {
      ...
      subtitle: "AI makes it easy to generate working HTML tools, mini-games, and widgets in seconds. But sharing them usually requires creating a repository, setting up build tools, or configuring hosting. Pagepod was built to make sharing single-page web code effortless.",
      pillars: [
        {
          title: "Drop in and share",
          desc: "Upload an HTML file or zip archive to get an immediate link. No build step or dependencies required.",
        },
        {
          title: "Browser-level encryption",
          desc: "Encrypt private pages with AES-GCM directly in your browser. Decryption keys stay with you, not the server.",
        },
        {
          title: "Hardened sandbox",
          desc: "Scripts run in an isolated iframe sandbox with restricted permissions to prevent session leakage.",
        },
        {
          title: "CLI and API support",
          desc: "Push single-page artifacts directly from Cursor, terminal scripts, or custom automation pipelines.",
        },
      ],
