...
export const translations = {
  zh: {
    nav: {
      ...
      liteLifetimePerks: "10 GB 存储空间 · 100 个项目 · API 访问",
    ...
    workspace: {
      ...
      planBanner: {
        ...
        liteDesc: "支持托管多达 100 个项目，已解锁个人 API Token 自动化同步。",
        upgradePro: "升级至 Pro",
      },
    },
    settings: {
      ...
      plan: {
        ...
        liteStorageDesc: "支持托管多达 100 个项目，轻松归档原型与应用",
        freeStorageDesc: "最多支持托管 20 个轻量单页项目与基础预览",
        proFeatureTitle: "独立子域名与白标模式",
        liteFeatureTitle: "100 个项目与 API 自动化",
  ...
  en: {
    nav: {
      ...
      liteLifetimePerks: "10 GB Storage · 100 Projects · API Access",
    ...
    workspace: {
      ...
      planBanner: {
        ...
        liteDesc: "Host up to 100 projects with API token automation unlocked.",
    ...
    settings: {
      ...
      plan: {
        ...
        liteStorageDesc: "Host up to 100 projects, ideal for indies, tools, and prototypes",
        ...
        liteFeatureTitle: "100 Projects & API Access",
