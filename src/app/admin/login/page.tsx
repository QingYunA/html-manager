...
function LoginForm() {
  ...
  return (
    <Tabs defaultValue="admin" className="w-full">
      ...
      {/* Tab 2: Supabase Auth Email/Password & OAuth (GitHub + Google) */}
      <TabsContent value="supabase" className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button
            ...
            className="h-9 text-xs gap-1.5 font-medium border-border hover:bg-muted"
          >
      ...
      <Card className="w-full max-w-sm border-border shadow-lg">
        ...
        <CardFooter className="p-6 pt-0 border-t border-border/60 flex items-center justify-between text-[11px] text-muted-foreground mt-2">
          ...
          <span className="flex items-center gap-1">
            <ShieldCheck className="w-3 h-3 text-emerald-500" /> OAuth & 零知识认证
          </span>
        </CardFooter>
      </Card>
    </div>
